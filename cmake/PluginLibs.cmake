...
#arhive
if (WIN32)
  target_include_directories(${PACKAGE_NAME} PRIVATE "${PROJECT_SOURCE_DIR}/buildwin/libs/include")
  target_link_libraries(${PACKAGE_NAME} archive.lib)
  target_link_directories(${PACKAGE_NAME} PRIVATE "${PROJECT_SOURCE_DIR}/buildwin/libs")
endif ()